...
namespace Anderson
{   
    delegate void Integrand (double x, double[] fValues);
    
    static class HankelTransformsByAnderson
    {
      static double e02 = 1.22140275816017; // exp(0.2)
      static double einv = 0.818730753077982; // 1/exp(0.2)
...
// END OF J1 FILTER WEIGHTS
      ...
      public static void call(Integrand f, double r, double eps, int j0_n, int j1_n,
